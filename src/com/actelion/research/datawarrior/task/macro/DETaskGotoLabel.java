...
public class DETaskGotoLabel extends ConfigurableTask {
    public static final String TASK_NAME = "Goto Label";

    private static final String PROPERTY_LABEL = "label";

    private JTextField mTextFieldName;

	public DETaskGotoLabel(Frame parent) {
		super(parent, true);
		}
	...
	public void runTask(Properties configuration) {
		// the goto is actually performed by the DEMacroRecorder
		}
