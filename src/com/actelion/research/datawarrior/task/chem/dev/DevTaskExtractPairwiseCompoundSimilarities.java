...
public class DevTaskExtractPairwiseCompoundSimilarities extends AbstractTaskWithoutConfiguration {
	...
	public DevTaskExtractPairwiseCompoundSimilarities(DEFrame parent) {
		super(parent, true);
